...
export default new Vuex.Store({
  state: {
    lang: ['모든 언어', 'C++', 'C', 'Go', 'Java', 'PyPy3','Python3', ],
    langOrd: {'모든 언어': 0, 'C++': 1, 'C': 2, 'Go': 3, 'Java': 4, 'PyPy3': 5, 'Python3': 6, },

    slang: ['C++', 'C', 'Go', 'Java', 'PyPy3','Python3', ],
    langCodeMirror: ['text/x-c++src', 'text/x-csrc', 'text/x-c++src', 'text/x-java', 'text/x-python', 'text/x-python', ],
